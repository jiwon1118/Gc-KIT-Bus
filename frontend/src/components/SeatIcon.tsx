  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <button
        ...
        className={`
          relative w-10 h-10 sm:w-12 sm:h-12 rounded-lg transition-all duration-200 cursor-pointer border-2
          ${getSeatColor()}
      ...
      {showLabel && (
        <span className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 min-w-6 text-center">
          {seat.id}
        </span>
      )}
    </div>
